...
namespace Commerce.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925200000_AddCatalogTranslations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commerce.Domain.InstallmentPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("MerchantCost")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)");
                    ...
                    b.Property<string>("TermsReference")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Commerce.Domain.InstallmentSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InstallmentPlanId", "Sequence")
                        .IsUnique();
            ...
            modelBuilder.Entity("Commerce.Domain.OrderInventoryReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExpiresAt", "ReleasedAt", "FulfilledAt");

                    b.HasIndex("OrderId", "WarehouseId", "VariantId")
                        .IsUnique();

                    b.ToTable("order_inventory_reservations", null, t =>
                        {
                            t.HasCheckConstraint("ck_order_inventory_reservation_quantity", "\"Quantity\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Commerce.Domain.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("payments", null, t =>
                        {
                            t.HasCheckConstraint("ck_payment_amounts", "\"AmountAuthorized\" >= 0 AND \"AmountCaptured\" >= 0 AND \"AmountRefunded\" >= 0 AND \"AmountRefunded\" <= \"AmountCaptured\"");
                        });
                });

            modelBuilder.Entity("Commerce.Domain.PaymentAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Commerce.Domain.PaymentReconciliation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("ProviderCapturedAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)");

                    b.Property<decimal>("ProviderRefundedAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)");
                    ...
                    b.HasIndex("PaymentId", "EvaluatedAt");

                    b.ToTable("payment_reconciliations", (string)null);
                });

            modelBuilder.Entity("Commerce.Domain.PaymentWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Commerce.Domain.ProductRelationship", b =>
                {
                    ...
                    b.HasKey("SourceProductId", "TargetProductId", "Type");

                    b.HasIndex("TargetProductId");

                    b.HasIndex("SourceProductId", "Type", "RelevanceScore");

                    b.ToTable("product_relationships", null, t =>
                        {
                            t.HasCheckConstraint("ck_product_relationships_not_self", "\"SourceProductId\" <> \"TargetProductId\"");
                        });
                });
            ...
            modelBuilder.Entity("Commerce.Domain.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Commerce.Domain.InstallmentSchedule", b =>
                {
                    b.HasOne("Commerce.Domain.InstallmentPlan", "Plan")
                        .WithMany("Schedule")
            ...
            modelBuilder.Entity("Commerce.Domain.OrderInventoryReservation", b =>
                {
                    b.HasOne("Commerce.Domain.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Commerce.Domain.PaymentAttempt", b =>
                {
                    b.HasOne("Commerce.Domain.Payment", "Payment")
                        .WithMany("Attempts")
            ...
            modelBuilder.Entity("Commerce.Domain.Product", b =>
                {
                    ...
                    b.OwnsMany("Commerce.Domain.ProductAttribute", "Attributes", b1 =>
                        {
            ...
            modelBuilder.Entity("Commerce.Domain.ProductRelationship", b =>
                {
                    b.HasOne("Commerce.Domain.Product", "Source")
                        .WithMany()
                        .HasForeignKey("SourceProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Commerce.Domain.Product", "Target")
                        .WithMany()
